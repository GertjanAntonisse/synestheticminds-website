        ...
        <div className="container">
          ...
          <div className={styles.siTableWrap}>
            <table className={styles.siTable}>
              ...
              <tbody>
                {[
                  ['1', 'Intake conversation', '1. Get one question sharp: which decision is the client about to make, and on which system output is it based?\n2. Together decide where we join the work and for how long (two weeks to a month).\n3. Agree upfront: we take part, we do not judge.', 'Without a real decision behind it there is no focus. The question sets where we look, and the no-fault agreement makes people open later on.', 'S - The upfront no-fault agreement takes the fear out.\nQ - A sharp question focuses the observation.\nD - A clear start gives a clear end.\nC - No time wasted on too broad a scope.', 'The sharp question, written down.'],
                  ['2', 'Joining the work', '1. Take part in the work itself, not watching from a distance.\n2. Follow the daily flow, including the busy moments and the exceptions.\n3. Stay on the same side as the people; no separate observer position.', 'The capacity and the real logic live in the doing. You only see them by taking part, not from the sidelines.', 'S - Taking part rather than watching keeps the floor at ease.\nQ - You see the real work, not a staged version.\nD - First signals of where picture and work diverge.\nC - No costly observation setup, just joining in.', 'Field notes from taking part.'],
                  ['3', 'Observing and naming', '1. Record what actually happens, per group involved.\n2. Factual, without adding interpretation: what was seen, what was said, where the picture diverged from the work.\n3. Something out of scope? Name it, do not step in.', 'No-fault. It is information, not a verdict. Recognition for the people, insight for leadership. A gap between picture and work is the finding, not the reproach.', 'S - Factual and without judgement keeps it safe.\nQ - Recording per group makes the picture complete.\nD - The observation becomes the basis of the proposal.\nC - Role clarity prevents disrupting the work.', 'Observation document per group involved.'],
                  ['4', 'Conversations from taking part', '1. Give back what was observed and walk through it together.\n2. As a talk-document, not a report.\n3. Discuss the deviations and edge cases and test whether it holds.', 'The document secures the seeing, not the control. Drift becomes visible in the conversation, not ticked off.', 'S - A conversation, not a reckoning.\nQ - Testing with the people sharpens the picture.\nD - A shared picture enables a supported proposal.\nC - Misunderstandings out before anything is built.', 'Talk-document (the living SI).'],
                  ['5', 'Proposal grounded in lived experience', '1. Make visible and keep alive as a talk-document (Evident Design).\n2. What is stable and critical enough, secure hard in software (Invariant Design).\n3. The proposal rests on what we experienced, not on an assumption.', 'A proposal from reality, not off-the-shelf. Does the client want a solution sooner? See first, propose after.', 'S - A proposal the people recognise will hold.\nQ - Grounded in what actually happens.\nD - Concrete: what to see, what to secure, and how.\nC - No investment in something that does not fit.', 'The proposal, with scope and layers (ED/ID).'],
                ].map((row, i) => (
                  <tr key={i}>
                    {row.map((cell, j) => (
                      <td key={j}>{cell}</td>
